...
**_Grading: Each answer above is worth two points. However, if they try to game the system by putting the same answer in all three blanks, award zero points._**
...
**_Grading: For parts (b) through (e), each answer is worth 1 pt and is either right or wrong._**
...
**_Grading: Award 1 pt each for each value being in the correct location._**
