...
Show the state of the array below for each iteration of **_selection sort_**:
...
**_Grading: 1 pt per row, row has to be perfect to get the point for that row_**
...
**_Grading: 1 pt for level 0, 1 pt for level 1, 1 pt for each item in level 2. If extra items are included, subtract 1, cap at 0. Note: No need to add the value of k for each recursive call in the tree. They are printed in this solution for clarity's sake._** 
